...
function [integration_error, Nt, ft_5, integral_1000] = zadanie2()
    ...
    ft_5 = f(5);
    integral_1000 = trapezoidal_integration(@f, 1000);

    for i = 1:length(Nt)
        integration_result = trapezoidal_integration(@f, Nt(i));
...
function integral = trapezoidal_integration(f, k)
    % Zakres całkowania
    a = 0;
    b = 5;
